...
<div class="page">
    ...
    <c:if test="${!(superEnterprise==1 and personnelType==2)}">
        <a href="person-create-${enterpriseId}.html"><span class="addman">手动添加</span></a>
        <a href="download/template.xlsx"><span class="addman">下载模板</span></a>
...
<script type="text/javascript">
    ...
    function topage(data){
        ...
        if(page>1){
            pageHtml +='<li><a href="javascript:;" onclick="personlist('+(page-1)+')"><</a></li>';
        }
        ...
        for(var i=start;i<=end;i++){
            ...
            if(i==page){
                ...
                pageHtml +='<li><a href="javascript:;" onclick="personlist('+i+')">'+i+'</a></li>';
            }
        }
        if(page<totalPage){
            pageHtml +='<li><a href="javascript:;" onclick="personlist('+(page+1)+')">></a></li>';
